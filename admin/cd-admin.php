	...
	$this_car = '<div>';
		$this_car .= '<div class="car_detail_div">';
			$this_car .= '<div class="car_main_photo_box">';
				$this_car .= '<div id="main_thumb"><img onerror="ImgError(this, \'no_photo.gif\');" id="' . $post_id . '_pic" name="' . $post_id . '_pic" class="cd_main_photo car_demon_main_photo" width="350px" src="';
