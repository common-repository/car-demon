...
function manage_cars_for_sale_columns( $column ) {
	...
	if ( "ID" == $column ) {
		...
		echo $car_image;
		$nonce = wp_create_nonce( 'car_demon_admin_update_nonce_' . $post_id );
		echo '<input type="hidden" name="car_demon_admin_update_nonce_' . $post_id . '" id="car_demon_admin_update_nonce_' . $post_id . '" value="' . $nonce . '" />';
	} elseif ( "msrp" == $column ) {
		if ( $show_hide['retail'] != true ) {
			...
			echo '<br /><br />' . __( 'edit label', 'car-demon' );
		...
		echo '<div id="show_sold_' . $post_id . '">
				<select id="is_sold_' . $post_id . '" onchange="update_car_sold(' . $post_id . ', this, \'sold\')">
					<option value="'. __( 'No', 'car-demon' ) .'"' . ($sold == __( 'No', 'car-demon' ) || $sold == __( 'no', 'car-demon' ) ? ' selected' : '' ) . '>' . __( 'No', 'car-demon' ) . '</option>
					<option value="'. __( 'Yes', 'car-demon' ) .'"' . ($sold == __( 'Yes', 'car-demon' ) || $sold == __( 'yes', 'car-demon' ) ? ' selected' : '' ) . '>' . __( 'Yes', 'car-demon' ) . '</option>
				</select>
			</div>';
	}
}
