...
function search_shortcode_func( $atts ) {
	...
	$atts = shortcode_atts( array(
        ...
        __( 'result_page', 'car-demon' ) => $car_demon_options['inventory_page'],
		__( 'filter_condition', 'car-demon' ) => '',
		__( 'button_text', 'car-demon' ) => __( 'Search', 'car-demon'),
...
function payment_calculator_shortcode( $atts ) {
	$atts = shortcode_atts( array(
		__( 'price', 'car-demon' ) => '25000',
		__( 'apr', 'car-demon' ) => '10',
		__( 'term', 'car-demon' ) => '60',
		__( 'disclaimer1', 'car-demon' ) => __( 'It is not an offer for credit nor a quote.', 'car-demon' ),
		__( 'disclaimer2', 'car-demon' ) => __( 'This calculator provides an estimated monthly payment. Your actual payment may vary based upon your specific loan and final purchase price.', 'car-demon' ),
	), $atts, 'payment_calculator' );
	$x = car_demon_calculator_form( $atts['price'], $atts['apr'], $atts['term'], $atts['disclaimer1'], $atts['disclaimer2'] );
	return $x;
}
add_shortcode( __( 'payment_calculator', 'car-demon' ), 'payment_calculator_shortcode' );
?>