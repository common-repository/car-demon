...
function car_crf_theme_redirect() {
	...
	if ( $car_demon_options['cd_cdrf_style'] != 'default' ) {
		...
		if ( $is_mobile != 'Yes' ) {
			...
			//= TO DO - remove jquery.lightbox_me.js
			...
			wp_enqueue_style( 'cd-lightGallery-css', plugins_url() . '/car-demon/theme-files/js/lightGallery-1.6.0/dist/css/lightgallery.css' );
			wp_enqueue_style( 'cd-lightGallery-transitions-css', plugins_url() . '/car-demon/theme-files/js/lightGallery-1.6.0/dist/css/lg-transitions.min.css' );
			wp_register_script( 'cd-lightGallery-js', plugins_url() . '/car-demon/theme-files/js/lightGallery-1.6.0/dist/js/lightgallery.js',  array( 'jquery' ) );
			wp_localize_script( 'cd-lightGallery-js', 'cdTbParams', array(
				'is_mobile' => wp_is_mobile(),
			) );
			wp_enqueue_script( 'cd-lightGallery-js' );
			wp_enqueue_script( 'cd-lightGallery-share-js', plugins_url() . '/car-demon/theme-files/js/lightGallery-1.6.0/modules/lg-share.min.js', array( 'jquery', 'cd-lightGallery-js' ) );
			wp_enqueue_script( 'cd-lightGallery-zoom-js', plugins_url() . '/car-demon/theme-files/js/lightGallery-1.6.0/modules/lg-zoom.min.js', array( 'jquery', 'cd-lightGallery-js' ) );
			wp_enqueue_script( 'cd-lightGallery-fullscreen-js', plugins_url() . '/car-demon/theme-files/js/lightGallery-1.6.0/modules/lg-fullscreen.min.js', array( 'jquery', 'cd-lightGallery-js' ) );
			wp_enqueue_script( 'cd-lightGallery-thumbnails-js', plugins_url() . '/car-demon/theme-files/js/lightGallery-1.6.0/modules/lg-thumbnail.min.js', array( 'jquery', 'cd-lightGallery-js' ) );
			//= Load content replacement specific JS
